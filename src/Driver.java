public class Driver {
    public static void main(String[] args) {
        ...
        /* To test the extra credit, comment out the line above and un-comment this line.
        ...
        // drop student not on roster or waitlist
        dropped = course.dropStudent(studentToDrop);
        System.out.println("For " + studentToDrop.getName() + ", drop method should return false (student is not on the roster or waitlist): \t" + dropped);

        // drop student on roster
        studentToDrop = studentsInSchool[4]; // EE
        dropped = course.dropStudent(studentToDrop);
        System.out.println("\nFor " + studentToDrop.getName() + ", drop method should return true (student is enrolled on the roster): \t" + dropped);
